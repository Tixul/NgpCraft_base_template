...
REM     Place system.lib in the project root, or set an absolute path here.
SET systemLibPath=
REM Default clean build: leave systemLibPath empty.
REM Only set it when you explicitly need Toshiba flash helper symbols.
